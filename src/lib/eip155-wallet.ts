...
import { getSignParamsMessage, getSignTypedDataParamsData } from '../utils/misc'
...
export interface EIP155WalletInterface {
  ...
  [EIP155_METHODS.SignTypedData](domain: any, types: any, data: any): Promise<string>
  [EIP155_METHODS.SignTypedDataV3](domain: any, types: any, data: any): Promise<string>
  [EIP155_METHODS.SignTypedDataV4](domain: any, types: any, data: any): Promise<string>
